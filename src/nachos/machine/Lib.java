...
public final class Lib
{
   ...
   * 
   * @param range
   *          a positive value specifying the number of possible return values.
  ...
  public static Object constructObject (String className)
  {
    try
    {
      ...
      return loadClass(className).getConstructor(param_types).newInstance(
        params);
    }
    catch (Throwable e)
    {
   ...
   * the specified name and signature exists, is public, and returns the
   * specified type.
   * 
   * @param cls
