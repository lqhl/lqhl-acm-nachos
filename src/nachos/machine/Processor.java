...
public final class Processor
{
  ...
  private int readMem (int vaddr, int size) throws MipsException
  {
    ...
    if (Lib.test(dbgProcessor))
      System.out
        .println("\t\tvalue read=0x" + Lib.toHexString(value, size * 2));
  ...
  private void writeMem (int vaddr, int size, int value) throws MipsException
  {
    if (Lib.test(dbgProcessor))
      System.out.println("\twriteMem vaddr=0x" + Lib.toHexString(vaddr)
        + ", size=" + size + ", value=0x" + Lib.toHexString(value, size * 2));
  ...
  private class Instruction
  {
    ...
    private void print ()
    {
      ...
      {
        System.out.print("invalid: op=" + Lib.toHexString(op, 2) + " rs="
          + Lib.toHexString(rs, 2) + " rt=" + Lib.toHexString(rt, 2) + " rd="
          + Lib.toHexString(rd, 2) + " sh=" + Lib.toHexString(sh, 2) + " func="
  ...
  private static class Mips
  {
    ...
    static final int INVALID = 0, UNIMPL = 1, ADD = 2, SUB = 3, MULT = 4,
      DIV = 5, SLL = 6, SRA = 7, SRL = 8, SLT = 9, AND = 10, OR = 11, NOR = 12,
      XOR = 13, LUI = 14, MFLO = 21, MFHI = 22, MTLO = 23, MTHI = 24,
      JUMP = 25, BEQ = 26, BNE = 27, BLEZ = 28, BGTZ = 29, BLTZ = 30,
      BGEZ = 31, SYSCALL = 32, LOAD = 33, LWL = 36, LWR = 37, STORE = 38,
      SWL = 39, SWR = 40, MAX = 40;
    
    static final int IFMT = 1, JFMT = 2, RFMT = 3;
    
    static final int DST = 0x00000001, DSTRA = 0x00000002,
      OVERFLOW = 0x00000004, SRC1SH = 0x00000008, SRC2IMM = 0x00000010,
      UNSIGNED = 0x00000020, LINK = 0x00000040, DELAYEDLOAD = 0x00000080,
    ...
    static final Mips[] optable = {
      ...
      new Mips(LUI, "lui ti", IFMT, DST | SRC2IMM | UNSIGNED), new Mips(),
      ...
      new Mips(BGTZ, "bgtzl sj", IFMT, BRANCH), new Mips(), new Mips(),
      ...
      new Mips(SWR, "swr ta", IFMT, 0), new Mips(), new Mips(UNIMPL, "ll "),
      new Mips(), new Mips(), new Mips(), new Mips(), new Mips(), new Mips(),
      new Mips(), new Mips(UNIMPL, "sc "), new Mips(), new Mips(), new Mips(),
    ...
    static final Mips[] specialtable = {
      ...
      new Mips(JUMP, "jalr rs", RFMT, BRANCH | LINK | DST), new Mips(),
      new Mips(), new Mips(SYSCALL, "syscall "), new Mips(UNIMPL, "break "),
      new Mips(), new Mips(UNIMPL, "sync "),
      new Mips(MFHI, "mfhi d", RFMT, DST), new Mips(MTHI, "mthi s", RFMT, 0),
      new Mips(MFLO, "mflo d", RFMT, DST), new Mips(MTLO, "mtlo s", RFMT, 0),
      new Mips(), new Mips(), new Mips(), new Mips(),
      new Mips(MULT, "mult st", RFMT, 0),
      new Mips(MULT, "multu st", RFMT, UNSIGNED),
      new Mips(DIV, "div st", RFMT, 0),
      new Mips(DIV, "divu st", RFMT, UNSIGNED), new Mips(), new Mips(),
      ...
      new Mips(AND, "and dst", RFMT, DST), new Mips(OR, "or dst", RFMT, DST),
      new Mips(XOR, "xor dst", RFMT, DST), new Mips(NOR, "nor dst", RFMT, DST),
      new Mips(), new Mips(), new Mips(SLT, "slt dst", RFMT, DST),
      new Mips(SLT, "sltu dst", RFMT, DST | UNSIGNED), new Mips(), new Mips(),
      new Mips(), new Mips(), new Mips(), new Mips(), new Mips(), new Mips(),
      new Mips(), new Mips(), new Mips(), new Mips(), new Mips(), new Mips(),
      new Mips(), new Mips(), new Mips(), new Mips(), new Mips(), new Mips(), };
    ...
    static final Mips[] regimmtable = {
      ...
      new Mips(BGEZ, "bgezl sj", IFMT, BRANCH), new Mips(), new Mips(),
      new Mips(), new Mips(), new Mips(), new Mips(), new Mips(), new Mips(),
      new Mips(), new Mips(), new Mips(), new Mips(),
