...
public class OpenFile
{
   ...
   * of bytes successfully read. Advances the file pointer by this amount. If no
  ...
  /**
   * Write this file starting at the current file pointer and return the number
   * of bytes successfully written. Advances the file pointer by this amount. If
   * no bytes could be written because of a fatal error, returns -1.
   * 
   * @param buf
   *          the buffer to get the bytes from.
   * @param offset
