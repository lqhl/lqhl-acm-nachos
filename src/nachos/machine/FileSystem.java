...
public interface FileSystem
{
   ...
   * and <tt>create</tt> is <tt>true</tt>, creates the file with zero length. If
   * the file already exists, opens the file without changing it in any way.
   * 
   * @param name
   ...
   * open, it is up to the implementation to decide whether the file can still
   * be accessed or if it is deleted immediately.
   * 
   * @param name
